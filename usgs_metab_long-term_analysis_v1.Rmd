...
RMarkdown file to accompany: *Are annual river productivity regimes changing over time?,* a manuscript submitted to *Limnology and Oceanography* Special Issue on Changing Phenology in Aquatic Ecosystems.
...
readr::write_csv(table_s2,
                 'data/data_citation/ms_usgs_annual_metab/5_random_effects.csv')
...
readr::write_csv(table_s3,
                 'data/data_citation/ms_usgs_annual_metab/6_table_s3.csv')
```
